...
@export_range(0.05, 2) var cooldown: float = 0.1 # Firerate
...
@export var max_ammo: int = 30 # Magazine size
@export var reserve_ammo: int = 120 # Total reserve ammo
@export var reload_time: float = 2.0 # Seconds to reload
@export var auto_fire: bool = false # Full-auto weapon

@export_subgroup("Sounds")
@export var sound_shoot: String # Sound path
@export var sound_reload: String = "sounds/weapon_change.ogg" # Reload sound

@export_subgroup("Crosshair")
@export var crosshair: Texture2D # Image of crosshair on-screen

@export_subgroup("Info")
@export var display_name: String = "Weapon" # Display name in HUD